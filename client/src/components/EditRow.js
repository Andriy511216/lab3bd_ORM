                                ...
                                props.table.map( (row, index) => {
                                    ...
                                    return (
                                        ...
                                        <div className="form-group row" key={index}>
                                            ...
                                            <div className="col-sm-10"><input disabled={row.field === 'id' ? true : false} className="form-control" id={`edit-${row.field}-${entity[props.table[0].field]}`} name={row.field} type={type} onChange={e => editInputChangeHandler(e)} value={entity[row.field]} /></div>
                                        </div>
